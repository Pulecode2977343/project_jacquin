        ...
        container.innerHTML = `
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" id="recovery-code" class="form-input-neumorph with-icon" placeholder="123456" maxlength="6" style="letter-spacing: 5px; text-align: center;" required>
                </div>
            </div>
        `;
    }
        ...
        container.innerHTML = `
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="password" id="new-password" class="form-input-neumorph with-icon" placeholder="••••••••" required>
                    <i class="bi bi-eye-slash toggle-password" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; color: var(--color-humo-gris);"></i>
                </div>
                <!-- Strength Meter -->
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="password" id="confirm-password" class="form-input-neumorph with-icon" placeholder="••••••••" required>
                    <i class="bi bi-eye-slash toggle-password" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; color: var(--color-humo-gris);"></i>
                </div>
            </div>
        `;
