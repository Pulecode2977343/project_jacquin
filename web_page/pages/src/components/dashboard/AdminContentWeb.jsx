 ...
 *
 * Reutiliza estilos de academic.css:
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <i className="bi bi-layout-text-window-reverse" style={{
              fontSize: '1.8rem',
              color: 'rgba(147, 182, 238, 0.9)'
            }}></i>
            ...
            <button
              ...
              style={{
                background: activeTab === idx
                  ? 'rgba(147, 182, 238, 0.2)'
                  : 'transparent',
                border: activeTab === idx
                  ? '1px solid rgba(147, 182, 238, 0.4)'
                  : '1px solid rgba(147, 182, 238, 0.1)',
                color: activeTab === idx
                  ? '#93b6ee'
                  : 'rgba(147, 182, 238, 0.6)',
              ...
              onMouseEnter={(e) => {
                if (activeTab !== idx) {
                  e.target.style.background = 'rgba(147, 182, 238, 0.1)';
                }
              }}
              onMouseLeave={(e) => {
                if (activeTab !== idx) {
